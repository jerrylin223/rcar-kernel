...
static int rcsi2_d_phy_setting_v4h(struct rcar_csi2 *priv, int mbps)
{
	...
	/* over 1500,
	 * PPI_RW_DDLCAL_CFG_3[9:0], LUT form forumla!
	 * PPI_RW_DDLCAL_CFG_1[7:0], LUT
	 * PPI_RW_DDLCAL_CFG_5[9:4], LUT,
	 * PPI_RW_DDLCAL_CFG_5[3:0], LUT,
	 * CORE_DIG_IOCTRL_RW_AFE_LANE0_CTRL_2_8[12], LUT
	 * CORE_DIG_IOCTRL_RW_AFE_LANE1_CTRL_2_8[12], LUT
	 * CORE_DIG_IOCTRL_RW_AFE_LANE2_CTRL_2_8[12], LUT
	 * CORE_DIG_IOCTRL_RW_AFE_LANE3_CTRL_2_8[12], LUT
	 * CORE_DIG_IOCTRL_RW_AFE_LANE4_CTRL_2_8[12], LUT
	 */
	...
	if (mbps >= 2560)
		rcsi2_modify16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(2, 9), 6 << 5, 0xe0);
	else if (mbps >= 1280)
		rcsi2_modify16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(2, 9), 5 << 5, 0xe0);
	else if (mbps >= 640)
		rcsi2_modify16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(2, 9), 4 << 5, 0xe0);
	else if (mbps >= 320)
		rcsi2_modify16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(2, 9), 3 << 5, 0xe0);
	else if (mbps >= 160)
		rcsi2_modify16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(2, 9), 2 << 5, 0xe0);
	else if (mbps >= 80)
		rcsi2_modify16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(2, 9), 1 << 5, 0xe0);
	...
	/* over 1500
	 * CORE_DIG_DLANE_0_RW_HS_RX_1[7:0], LUT);
	 * CORE_DIG_DLANE_1_RW_HS_RX_1[7:0], LUT);
	 * CORE_DIG_DLANE_2_RW_HS_RX_1[7:0], LUT);
	 * CORE_DIG_DLANE_3_RW_HS_RX_1[7:0], LUT);
	 */
	...
	/* over 1500
	 * CORE_DIG_DLANE_0_RW_HS_RX_3, [8:3][2:0], LUT
	 * CORE_DIG_DLANE_1_RW_HS_RX_3, [8:3][2:0], LUT
	 * CORE_DIG_DLANE_2_RW_HS_RX_3, [8:3][2:0], LUT
	 * CORE_DIG_DLANE_3_RW_HS_RX_3, [8:3][2:0], LUT
	 * CORE_DIG_DLANE_0_RW_HS_RX_6, [15:8], LUT
	 * CORE_DIG_DLANE_1_RW_HS_RX_6, [15:8], LUT
	 * CORE_DIG_DLANE_2_RW_HS_RX_6, [15:8], LUT
	 * CORE_DIG_DLANE_3_RW_HS_RX_6, [15:8], LUT
	 */
				    ...
				    struct v4l2_subdev_state *state)
{
	...
	if (priv->cphy) {
		for (unsigned int l = 0; l < 3; l++) {
			rcsi2_write16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(l, 9), cphy->lane29);
			rcsi2_write16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(l, 7), cphy->lane27);
		}
	} else {
		...
		for (unsigned int l = 0; l < 5; l++) {
			rcsi2_write16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(l, 9), val_2_9);
			rcsi2_write16(priv, V4H_CORE_DIG_IOCTRL_RW_AFE_LANEl_CTRL_2_REG(l, 15), val_2_15);
		}
	}
